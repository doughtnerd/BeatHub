...
{#if $topRatedSongsStore.songs.length == 0}
  {#await handleLoadMore()}
    <span>Loading Songs...</span>
  {:then songs}
    <BeatmapList>

      {#each $topRatedSongsStore.songs as beatmap}
        <BeatmapListItem
